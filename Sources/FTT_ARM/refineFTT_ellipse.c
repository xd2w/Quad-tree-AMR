...
//    getchar();
    ...
    if(ptListIntersectBox_extended(pList, nPoint, rectangle, &index))
    {
      ...
      if (cLv < minLevel + 3){
        ...
        // ave_kappa = 0.25*(equation_analytical_curvature(xCell[iCell], yCell[iCell], xc, yc)\
        //             + equation_analytical_curvature(xCell[iCell] + dx, yCell[iCell], xc, yc)\
        //             + equation_analytical_curvature(xCell[iCell] + dx, yCell[iCell] + dy, xc, yc)\
        //             + equation_analytical_curvature(xCell[iCell], yCell[iCell] + dy, xc, yc));
        
        // ave_kappa = equation_analytical_curvature(xCell[iCell] + dx/2, yCell[iCell] + dy/2, xc, yc);
